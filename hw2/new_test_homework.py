...
class TestLibraryManagement(unittest.TestCase):
    ...
    def test_01_add_and_list_books(self, mock_stdout):
        ...
        book2 = {'title': 'Animal Farm', 'author': 'George Orwell'}
        add_book(self.library, book1['title'], book1['author'])
        add_book(self.library, book2['title'], book2['author'])
        ...
        # Check for the string representation of the dictionary, which is what print() produces.
        self.assertIn(str(book1), output)
        self.assertIn(str(book2), output)
