...
# x_ca = ca_data['Date'].head()
# y_ca = ca_data['accident_count'].head()

# x_fl = fl_data['Date'].head()
# y_fl = fl_data['accident_count'].head()

# x_tx = tx_data['Date'].head()
# y_tx = tx_data['accident_count'].head()

# x_ny = ny_data['Date'].head()
# y_ny = ny_data['accident_count'].head()
